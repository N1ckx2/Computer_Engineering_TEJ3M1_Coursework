...
void randomize ( int arr[], int n ) //this function randomizes array
{
...
string questions[] [5] = 
    ...
    }; //this array stores all of our questions
int aners[] = {2, 1, 3, 1, 1, 4, 1, 2, 2, 1, 3, 4, 2, 1}; //this array has all of our answers 
int leds[] = { (128 + 64 + 32), (64 + 32), (32) }; // this array stores the status of the LEDs
int hello = 0; //this stores the position in which the question is in the array
int score = 0; //this variable counts the score
void wrong2 (int sleep) //this function is used if the user runs out of time
{
...
void wrong (int sleep) //this functions is used if the user runs the question wrong
{
...
void menu ()
{
    ...
    do
    {
        ...
        for (int i = 0 ; i < 14 ; i++)
        {
            time = 10; //time is reset
            input = 120, input2 = 120; //makes input blank
            Out32 (PPORT_BASE, leds [hello]); //outputs LEDs
            for (int x = 0 ; x < 5 ; x++)
            {
            ...
            if (input == 120)
            {
                wrong2 (sleep); //if the input was blank
            }
            //*********************************The next section of code is used to see if the user got tha nswer right**********************
            else if (aners [i] == 1)
            {
